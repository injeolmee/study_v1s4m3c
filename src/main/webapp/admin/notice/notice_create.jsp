...
<DIV class='content'> 
  ...
  <div style='text-align:center;'>
      ...
      <div class="form-group">   
        ...
        <div class="col-md-7">
          <input type='text' class="form-control input-md" name='ntitle' id='ntitle' value='' required="required">
        </div>        
      </div>
      <div class="form-group">   
        <label for="nseqno" class="col-md-offset-1 col-md-1 control-label" style='text-align: center; padding-left: 5%;'>출력순서</label>
        <div class="col-md-7" style='text-align: left;'>
          <input type='number' class="form-control input-md" name='nseqno' id='nseqno' value='1' required="required" style='width:20%;'>
        </div>        
      </div>   
      <div class="form-group">   
        <div class="col-md-offset-1 col-md-9" style='padding-left: 5%;'>
          <textarea class="form-control input-md" name='ncontent' id='ncontent' rows='10'></textarea>
        </div>
      </div>
    <DIV style='text-align: center; padding:10%;'>
      <button type="submit" style='margin-top: 5%;'>등록</button>
