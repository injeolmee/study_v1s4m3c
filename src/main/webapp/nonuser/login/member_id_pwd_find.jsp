  ...
  <div class="modal fade modal-sm" id="myModal" role="dialog" style='position: absolute; top:30%; left:56%; width: 25%; display: none;'>
    ...
    <div class="logmod__container" style='width: 27%; margin: 0px auto; padding-top: 30px;'>
      <ul class="logmod__tabs">
        <li data-tabtar="lgm-1"><a href="#">회원ID 찾기</a></li>
        <li data-tabtar="lgm-2"><a href="#">회원Passwd 찾기</a></li>
      </ul>
        ...
        <div class="logmod__form">
            <div class="sminputs">
              <div class="input full">
                ...
                <input class="string optional" style='margin-bottom: 0px;' maxlength="255" id="memname" name="memname" value='' placeholder="이름" type="text" size="50" />
              </div>
            </div>
            <div class="sminputs">
              <div class="input full">
                <label class="string optional" for="user-pw">EMAIL</label>
                <input class="string optional" maxlength="255" id="mememail" name="mememail" value='' placeholder="이메일" type="email" size="50" />
              </div>
            ...
            <div class="simform__actions">
              <input class="sumbit" name="commit" type="button" onclick="find_memid();" value="아이디 찾기" />
            </div> 
        </div> 
      ...
      <div class="logmod__tab lgm-2">
        <div class="logmod__form">
            <div class="sminputs">
              <div class="input full">
                <label class="string optional" for="user-name">NAME</label>
                <input class="string optional" style='margin-bottom: 0px;' maxlength="255" id="memname1" name="memname1" value='' placeholder="이름" type="text" size="50" />
              </div>
            </div>
            <div class="sminputs">
              <div class="input full">
                <label class="string optional" for="user-name">ID</label>
                <input class="string optional" style='margin-bottom: 0px;' maxlength="255" id="memid1" name="memid1" value='' placeholder="아이디" type="text" size="50" />
              </div>
            </div>
            <div class="sminputs">
              <div class="input full">
                <label class="string optional" for="user-pw">EMAIL</label>
                <input class="string optional" maxlength="255" id="mememail1" name="mememail1" value='' placeholder="이메일" type="email" size="50" />
              </div>
              <div class="" style='padding: 0px; text-align: left; margin-bottom: 10px;'>
            ...
            <div class="simform__actions">
              <input class="sumbit" name="commit" type="button" onclick="find_mempasswd();" value="비밀번호 찾기" />
            </div> 
        </div> 
        <div class="logmod__alter">
          <div class="logmod__alter-container">
