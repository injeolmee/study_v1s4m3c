...
<div class="logmod__container" style='width: 50%; margin: 0px auto; padding-top: 30px;'>
  <ul class="logmod__tabs">
    <li data-tabtar="lgm-1"><a href="#">회원 수정</a></li>
  </ul>
      ...
      <c:choose>
        ...
        <div class="sminputs">
          <div class="input full">
            ...
            <input class="string optional" style='margin-bottom: 0px; width: 45%;' maxlength="255" id="mememail" name="mememail" value='${memberVO.mememail }' placeholder="이메일" type="email" size="50" />
        ...
        <div class="sminputs">
          <div class="input full">
            ...
            <input class="string optional" style='margin-bottom: 0px; width: 45%;' maxlength="255" id="membirth" name="membirth" value="${memberVO.membirth }" placeholder="예) 19990101" type="text" size="50" />
        ...
        <div class="sminputs">
          <div class="input full">
            ...
            <label class="string optional">
            <input type="radio" name="memgender" id="male" value="남" style= 'width: 10%;' > <span style='font-size: 15px;'>남자</span>
        ...
        <div class="sminputs">
          <div class="input full">
            ...
            <input class="string optional" style='margin-bottom: 0px; width: 45%;' maxlength="255" id="memphone" name="memphone" value='${memberVO.memphone }' placeholder="예) 01012345678" type="text" size="50" />
            <div style='float: right; width: 15%;'>
        ...
        <div class="sminputs">
          <div class="input full">
            ...
            <input class="string optional" style='margin-bottom: 0px; width: 45%;' maxlength="255" id="memsns" name="memsns" value='${memberVO.memsns }' placeholder="예) 트위터 홍길동" type="text" size="50" />
            <div style='float: right; width: 15%;'>
        ...
        <div class="sminputs" style='height: 130px;'>
          <div class="input full">
            ...
            <textarea class= 'form-control' rows="3" id="memintro" name="memintro" placeholder="자기소개를 해주세요">${memberVO.memintro }</textarea>
          </div>
        </div>  
