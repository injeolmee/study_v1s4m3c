...
<FORM name='frm' method='POST' action='/study/user/qnaboard/create.do'
  ...
  <DIV class = "form-group form-group-sm">
    ...
    <DIV class="col-md-6" style='width: 65%;'>
      <input type='text' class="form-control input-lg" name='qnatitle' id='qnatitle' value='질문 제목' required="required">
    </DIV>
  </DIV>
  ...
  <div class="form-group">   
    ...
    <div class="col-md-6" style='width: 64.5%;'>
      <textarea class="form-control input-md" name='qnacont' id='qnacont' rows='12' cols='12'>질문 내용</textarea>
      <br>
    </div>
  </div>
