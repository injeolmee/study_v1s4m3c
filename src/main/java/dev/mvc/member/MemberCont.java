...
public class MemberCont {
   ...
   */
  @ResponseBody
  @RequestMapping(value = "/nonuser/login/memberjoin.do", method = RequestMethod.POST, produces = "text/plain;charset=UTF-8")
  public String memberjoin(HttpServletRequest request, MemberVO memberVO)
  ...
  /*
   * @RequestMapping(value = "/member/mailForm.do") public String mailForm() {
   * 
   * return "/member/mailForm"; }
   */
  /*
   * @RequestMapping(value = "/member/mailForm.do") public ModelAndView
   * mailForm(String mememail) { ModelAndView mav = new ModelAndView();
   * mav.setViewName("/member/mailForm"); String toemail = mememail;
...
/*    System.out.println("word:" + word);
  ...
  public String mem_read_pwdcheck(String modal_pwd, MemberVO memberVO, HttpSession session)
    ...
    String mempasswd = memberVO.getMempasswd(); // 세션에 저장된 암호화된 패스워드
   ...
   */
  @ResponseBody
  @RequestMapping(value = "/user/member/mem_update.do", method = RequestMethod.POST, produces = "text/plain;charset=UTF-8")
  public String mem_update(HttpServletRequest request, HttpSession session, MemberVO memberVO)
      throws UnsupportedEncodingException, InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException,
      InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException {
 ...
 // 관리자가 회원 수정시에
    if(memauth == null || memauth == "") {
      mempasswd = memberVO_old.getMempasswd();
      memberVO.setMempasswd(mempasswd);
      System.out.println("회원권한이 널일떄: " + mempasswd);
    } else { // 본인 회원이 수정할때 
      memauth = memberVO_old.getMemauth();
      memberVO.setMemauth(memauth);
      
      // 패스워드 암호화
      AES256Util aes256 = new AES256Util();
      System.out.println(mempasswd);
    ...
    String upDir = Tool.getRealPath(request, "/nonuser/login/storage");
    MultipartFile file1MF = memberVO.getFile1MF();
    // System.out.println("file1MF1 : "+file1MF);
    String memphoto = ""; // 컬럼에 저장할 파일명
    long memsize;
    String memphoto_t = "";
  ...
  @RequestMapping(value = "/nonuser/login/login.do", method = RequestMethod.GET)
   ...
   */
  @ResponseBody
  @RequestMapping(value = "/nonuser/login/login.do", method = RequestMethod.POST, produces = "text/plain;charset=UTF-8")
  public String login(HttpServletRequest request, HttpServletResponse response, HttpSession session,
      MemberVO memberVO, String memid, String mempasswd)
      throws UnsupportedEncodingException, InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException,
      InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException {
    System.out.println("--> login() POST called.");
    // System.out.println("memberVO.getMemid(): " + memberVO.getMemid());
    // System.out.println("memberVO.getMempasswd(): " +
    ...
    int login_cnt = 0;
    if(memauth.equals("U") == true) { // 회원권한 U일 경우
  ...
  public String mempasswd_change(HttpServletRequest request, MemberVO memberVO, String mempasswd, int memberno)
      throws UnsupportedEncodingException, InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException,
      InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException {
    String root = request.getContextPath();
    JSONObject obj = new JSONObject();
  ...
  @RequestMapping(value = "/user/member/mem_delete.do", method = RequestMethod.GET)
  public ModelAndView mem_delete(int memberno) {
    // System.out.println("--> mem_delete() GET executed");
    ModelAndView mav = new ModelAndView();
    mav.setViewName("/user/member/mem_delete"); // webapp/member/mem_update.jsp
   ...
   */
  @ResponseBody
  @RequestMapping(value = "/user/member/mem_delete.do", method = RequestMethod.POST, produces = "text/plain;charset=UTF-8")
  public String mem_delete(String mempasswd_d, MemberVO memberVO, HttpSession session)
      throws UnsupportedEncodingException, InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException,
      InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException {
    JSONObject obj = new JSONObject();
    
    String delete_email = memberProc.key(); // 회원 탈퇴시 이메일 랜덤키로 변환
    ...
    String mempasswd = memberVO.getMempasswd();
    System.out.println("mempasswd 삭제: " + mempasswd);
    
    // 패스워드 암호화
    AES256Util aes256 = new AES256Util();
    mempasswd_d = aes256.aesEncode(mempasswd_d); 
    System.out.println("mempasswd_d: " + mempasswd_d);
    
    int cnt_mempasswd = 0; // 패스워드 검사 일치 1, 불일치 2
    int cnt_withdraw = 0; // 탈퇴 성공 숫자 1, 실패 2

    if (mempasswd_d.equals(mempasswd) == true) { // 패스워드 일치
      cnt_mempasswd = 1;
      memberVO.setMememail(delete_email);
      memberVO.setMemauth("B");
      if(memberProc.mem_delete(memberVO) == 1) {
        cnt_withdraw = 1;
   ...
   */
  @ResponseBody
  @RequestMapping(value = "/admin/member/adm_mem_delete.do", method = RequestMethod.GET, produces = "text/plain;charset=UTF-8")
  public String adm_mem_delete(int memberno, MemberVO memberVO, HttpSession session)
      throws UnsupportedEncodingException, InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException,
      InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException {
    // System.out.println("adm_mem_delete get!");
    JSONObject obj = new JSONObject();
